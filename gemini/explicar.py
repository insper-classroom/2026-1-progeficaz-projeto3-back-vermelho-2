...
if __name__ == "__main__":
    ...
    if hasattr(mod, "explicar"):
        mod.explicar()
    else:
        print("Função 'explicar' não encontrada em api_gemini.py")
        sys.exit(1)
