#!/usr/bin/env python3
"""Chama a função `questionario()` definida em `api gemini.py`.

Carrega o arquivo pelo caminho (não importa que o nome do arquivo contenha espaços)
e executa a função `questionario()`.
"""
...
if __name__ == "__main__":
    ...
    if hasattr(mod, "questionario"):
        mod.questionario()
    else:
        print("Função 'questionario' não encontrada em api gemini.py")
        sys.exit(1)
